    ...
    <v-container aling="center" :loading="loading">
        ...
        <div>
            ...
            transition="scale-transition"
                >     
                <v-list-item-title> <p class="title white-text" >Hubo errores al intentar actualizar la información el usuario</p> </v-list-item-title>
                        ...
                        <v-card color="#9F2A2A" outlined>
                            <v-list-item>
                                ...
                                <v-list-item-content class="mt-2 mb-2">
                                    <v-list-item-title><h2>Editar Usuario</h2></v-list-item-title>
                                    <v-list-item-subtitle>Edite la información que requiera</v-list-item-subtitle>
                                </v-list-item-content>
                            </v-list-item>
                        </v-card>
                        <!-- <v-card color="#9F2A2A">
...
export default {
    ...
    methods: {
        getUser () {
            try {
                axios.get("../../api/users/"+this.$route.params.id).then(({ data }) => (this.user = data))
            } catch (error) {
